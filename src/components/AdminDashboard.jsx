    ...
    <div className="admin-page-wrapper">
      ...
      <div className="adm-root">
        ...
        <style>{`
          ...
          .adm-card:hover { background: rgba(255, 255, 255, 0.03); }
          .loyalist-border { border-left: 3px solid rgba(255, 204, 0, 0.5); }
          .formalist-border { border-left: 3px solid rgba(255, 107, 107, 0.5); }

          .adm-card-left { flex-shrink: 0; }
          .adm-avatar {
            width: 40px;
            height: 40px;
            border-radius: 50%;
          ...
          @media (max-width: 768px) {
            .adm-root { padding: 76px 16px 30px; margin: 10px auto; border-radius: 1.5rem; }
